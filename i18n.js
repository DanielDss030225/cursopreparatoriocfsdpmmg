...
const TRANSLATIONS = {
  'pt': {
    ...
    toast_ia_title: 'Bizu da Aprovação (IA)',
    toast_ia_desc: 'Sua assistente inteligente está pronta para tirar dúvidas sobre o edital e as matérias do concurso!',
    toast_scale_title: 'Planejamento Semanal',
    toast_scale_desc: 'Fique por dentro da missão do dia! Confira o cronograma de estudos para não perder nenhuma matéria.',
    toast_dont_show_again: 'Não mostrar novamente',
    toast_btn_open: 'Chamar IA',
    toast_btn_scale: 'Ver Missão',
